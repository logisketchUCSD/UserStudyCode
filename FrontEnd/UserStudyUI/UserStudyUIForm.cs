...
namespace UserStudyUI
{
	...
	/// </summary>
	public class UserStudyUIForm : System.Windows.Forms.Form
	{	
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// Internals
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/// </summary>
		private ConverterJnt.ReadJnt readJnt;
		...
		/// </summary>
		private event FirePauseCountdown PauseTriggerFiredEvent;
		...
		private System.Windows.Forms.MenuItem feedbackMenuItem;
		private System.Windows.Forms.MenuItem colorFeedbackMenuItem;
		private System.Windows.Forms.MenuItem textLabelFeedbackMenuItem;
		private System.Windows.Forms.MenuItem recognizerMenuItem;
		private System.Windows.Forms.MenuItem dummyRecognizerMenuItem;
		private System.Windows.Forms.MenuItem wireErrorRecognizerMenuItem;
		private System.Windows.Forms.MenuItem wizardRecognizerMenuItem;
		private System.Windows.Forms.MenuItem setFormTitleMenuItem;
		private System.Windows.Forms.MenuItem errorMenuItem;
		private System.Windows.Forms.MenuItem errorOffMenuItem;
		private System.Windows.Forms.MenuItem er85MislabelMenuItem;
		private System.Windows.Forms.MenuItem er85NeglectMenuItem;
		private System.Windows.Forms.MenuItem toggleSocketClientMenuItem;
		private System.Windows.Forms.MenuItem reconnectSocketClientMenuItem;
		/// <summary>
		...
		public UserStudyUIForm()
		{
			...
			// Right now, we use DateTime.Now for stroke data; there are probably better
			// ways of collecting time. 
			...
			this.wizardRecognizerMenuItem_Click(null, null);

			// Create the default feedback mechanism
			feedbackMechanism = new StrokeColoringFeedbackMechanism(this.sketchPicture);
			...
			//// Hide sketch/erase buttons because our user study tablet has an eraser
			//sketchRadio.Visible = false;
			//eraseRadio.Visible = false;
		}
		...
		private void InitializeComponent()
		{
			...
			this.feedbackMenuItem = new System.Windows.Forms.MenuItem();
			this.colorFeedbackMenuItem = new System.Windows.Forms.MenuItem();
			this.textLabelFeedbackMenuItem = new System.Windows.Forms.MenuItem();
			this.recognizerMenuItem = new System.Windows.Forms.MenuItem();
			this.dummyRecognizerMenuItem = new System.Windows.Forms.MenuItem();
			this.wireErrorRecognizerMenuItem = new System.Windows.Forms.MenuItem();
			this.wizardRecognizerMenuItem = new System.Windows.Forms.MenuItem();
			this.errorMenuItem = new System.Windows.Forms.MenuItem();
			this.errorOffMenuItem = new System.Windows.Forms.MenuItem();
			this.er85MislabelMenuItem = new System.Windows.Forms.MenuItem();
			this.er85NeglectMenuItem = new System.Windows.Forms.MenuItem();
			this.setFormTitleMenuItem = new System.Windows.Forms.MenuItem();
			this.toggleSocketClientMenuItem = new System.Windows.Forms.MenuItem();
			this.reconnectSocketClientMenuItem = new System.Windows.Forms.MenuItem();
			...
			this.adminMenuItem.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																						  ...
																						  this.recognizerMenuItem,
																						  this.errorMenuItem,
																						  this.setFormTitleMenuItem,
																						  this.toggleSocketClientMenuItem,
																						  this.reconnectSocketClientMenuItem});
			this.adminMenuItem.Text = "Admin";
			// 
			// triggerMenuItem
			// 
			this.triggerMenuItem.Index = 0;
			this.triggerMenuItem.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
			...
			// feedbackMenuItem
			// 
			this.feedbackMenuItem.Index = 1;
			this.feedbackMenuItem.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																							 this.colorFeedbackMenuItem,
																							 this.textLabelFeedbackMenuItem});
			this.feedbackMenuItem.Text = "Feedback";
			// 
			// colorFeedbackMenuItem
			// 
			this.colorFeedbackMenuItem.Checked = true;
			this.colorFeedbackMenuItem.Index = 0;
			this.colorFeedbackMenuItem.Text = "Color Feedback";
			this.colorFeedbackMenuItem.Click += new System.EventHandler(this.colorFeedbackMenuItem_Click);
			// 
			// textLabelFeedbackMenuItem
			// 
			this.textLabelFeedbackMenuItem.Index = 1;
			this.textLabelFeedbackMenuItem.Text = "Text Label Feedback";
			this.textLabelFeedbackMenuItem.Click += new System.EventHandler(this.textLabelFeedbackMenuItem_Click);
			// 
			// recognizerMenuItem
			// 
			this.recognizerMenuItem.Index = 2;
			this.recognizerMenuItem.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																							   this.dummyRecognizerMenuItem,
																							   this.wireErrorRecognizerMenuItem,
																							   this.wizardRecognizerMenuItem});
			this.recognizerMenuItem.Text = "Recognizer";
			// 
			// dummyRecognizerMenuItem
			// 
			this.dummyRecognizerMenuItem.Index = 0;
			this.dummyRecognizerMenuItem.Text = "Dummy Recognizer";
			this.dummyRecognizerMenuItem.Click += new System.EventHandler(this.dummyRecognizerMenuItem_Click);
			// 
			// wireErrorRecognizerMenuItem
			// 
			this.wireErrorRecognizerMenuItem.Checked = true;
			this.wireErrorRecognizerMenuItem.Index = 1;
			this.wireErrorRecognizerMenuItem.Text = "Wire/Error Recognizer";
			this.wireErrorRecognizerMenuItem.Click += new System.EventHandler(this.wireErrorRecognizerMenuItem_Click);
			// 
			// wizardRecognizerMenuItem
			// 
			this.wizardRecognizerMenuItem.Index = 2;
			this.wizardRecognizerMenuItem.Text = "Wizard Recognizer";
			this.wizardRecognizerMenuItem.Click += new System.EventHandler(this.wizardRecognizerMenuItem_Click);
			// 
			// errorMenuItem
			// 
			this.errorMenuItem.Index = 3;
			this.errorMenuItem.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																						  this.errorOffMenuItem,
																						  this.er85MislabelMenuItem,
																						  this.er85NeglectMenuItem});
			this.errorMenuItem.Text = "Error";
			// 
			// errorOffMenuItem
			// 
			this.errorOffMenuItem.Checked = true;
			this.errorOffMenuItem.Index = 0;
			this.errorOffMenuItem.Text = "Off";
			this.errorOffMenuItem.Click += new System.EventHandler(this.errorOffMenuItem_Click);
			// 
			// er85MislabelMenuItem
			// 
			this.er85MislabelMenuItem.Index = 1;
			this.er85MislabelMenuItem.Text = "ER .85 and mislabel";
			this.er85MislabelMenuItem.Click += new System.EventHandler(this.er85MislabelMenuItem_Click);
			// 
			// er85NeglectMenuItem
			// 
			this.er85NeglectMenuItem.Index = 2;
			this.er85NeglectMenuItem.Text = "ER .85 and omit label error";
			this.er85NeglectMenuItem.Click += new System.EventHandler(this.er85NeglectMenuItem_Click);
			// 
			// setFormTitleMenuItem
			// 
			this.setFormTitleMenuItem.Index = 4;
			this.setFormTitleMenuItem.Text = "Set Form Title";
			this.setFormTitleMenuItem.Click += new System.EventHandler(this.setFormTitleMenuItem_Click);
			// 
			// toggleSocketClientMenuItem
			// 
			this.toggleSocketClientMenuItem.Enabled = false;
			this.toggleSocketClientMenuItem.Index = 5;
			this.toggleSocketClientMenuItem.Text = "Toggle SocketClient";
			this.toggleSocketClientMenuItem.Click += new System.EventHandler(this.toggleSocketClientMenuItem_Click);
			// 
			// reconnectSocketClientMenuItem
			// 
			this.reconnectSocketClientMenuItem.Index = 6;
			this.reconnectSocketClientMenuItem.Text = "Reconnect SocketClient";
			this.reconnectSocketClientMenuItem.Click += new System.EventHandler(this.reconnectSocketClientMenuItem_Click);
			// 
			// toolBar1
			// 
		...
		static void Main() 
		{
			Application.Run(new UserStudyUIForm());
		}
		...
		/// inteface to the user.  This function also serves to reset the
		/// interface back to its original state (minus admin settings
		/// already set through the admin menu).
		/// </summary>
		/// <param name="sender">Event sender</param>
		/// <param name="e">Event object</param>
		private void newSketchItem_Click(object sender, System.EventArgs e)
		{
			...
			// Refresh other internals
			inkToSketchIds = new Hashtable();
			lassoStrokes = new ArrayList();
			lassoStrokeCollecting = false;
			annotationStrokeIds = new ArrayList();
		...
		private void recognizeButton_Click(object sender, System.EventArgs e)
		{
			...
			{
				this.statusBar.Text = "Status: Triggering recognition....";
		...
		/// <summary>
		/// Enables the stroke coloring feedback mechanism
		/// <see cref="FeedbackLayer.StrokeColoringFeedbackMechanism"/>
		/// </summary>
		private void colorFeedbackMenuItem_Click(object sender, System.EventArgs e)
		{
			// Set up admin menu
			colorFeedbackMenuItem.Checked = true;
			textLabelFeedbackMenuItem.Checked = false;

			// Clear the sketch first
			this.newSketchItem_Click(sender, e);

			this.feedbackMechanism = null;
			this.feedbackMechanism = new StrokeColoringFeedbackMechanism(this.sketchPicture);
		}

		/// <summary>
		/// Enables the stroke labeling feedback mechanism
		/// <see cref="TextLabelFeedbackMechanism"/>
		/// </summary>
		private void textLabelFeedbackMenuItem_Click(object sender, System.EventArgs e)
		{
			// Set up admin menu
			colorFeedbackMenuItem.Checked = false;
			textLabelFeedbackMenuItem.Checked = true;

			// Clear the sketch first
			this.newSketchItem_Click(sender, e);

			this.feedbackMechanism = null;
			this.feedbackMechanism = new TextLabelFeedbackMechanism();
		}

		/// <summary>
		/// Enables a dummy recognizer that simply returns a predefined file as a recognition result.
		/// <see cref="DummyRecognizer"/>
		/// </summary>
		private void dummyRecognizerMenuItem_Click(object sender, System.EventArgs e)
		{
			// Set up admin menu
			dummyRecognizerMenuItem.Checked = true;
			wireErrorRecognizerMenuItem.Checked = false;
			wizardRecognizerMenuItem.Checked = false;

			// Unhook from old recognizer, if applicable
			if (this.recognizer != null)
				this.recognizer.RecognitionEvent -= new RecognitionResultsEventHandler(recognizer_RecognitionEvent);

			this.recognizer = new DummyRecognizer();
			this.recognizer.RecognitionEvent += new RecognitionResultsEventHandler(recognizer_RecognitionEvent);
		}

		/// <summary>
		/// Enables the wire label recognizer that randomly triggers errors.
		/// <see cref="WireLabelRecognizer"/>
		/// </summary>
		private void wireErrorRecognizerMenuItem_Click(object sender, System.EventArgs e)
		{
			// Set up admin menu
			dummyRecognizerMenuItem.Checked = false;
			wireErrorRecognizerMenuItem.Checked = true;
			wizardRecognizerMenuItem.Checked = false;
			...
			this.recognizer = new WireLabelRecognizer();
			this.recognizer.RecognitionEvent += new RecognitionResultsEventHandler(recognizer_RecognitionEvent);
		
		}

		/// <summary>
		/// Enables recognition using a networked Wizard recognizer
		/// <see cref="WizardRecognizer"/>
		/// </summary>
		private void wizardRecognizerMenuItem_Click(object sender, System.EventArgs e)
		{
			// Set up admin menu
			dummyRecognizerMenuItem.Checked = false;
			wireErrorRecognizerMenuItem.Checked = false;
			wizardRecognizerMenuItem.Checked = true;

			// Unhook from old recognizer, if applicable
			if (this.recognizer != null)
				this.recognizer.RecognitionEvent -= new RecognitionResultsEventHandler(recognizer_RecognitionEvent);

			WizardRecognizer wizardRecognizer = new WizardRecognizer();
			this.recognizer = wizardRecognizer;
			this.recognizer.RecognitionEvent += new RecognitionResultsEventHandler(recognizer_RecognitionEvent);
			//wizardRecognizer.showSocketClientGui(true);
		}

		/// <summary>
		/// Sets the title of this form.  Utility function for running user studies.  The 
		/// experimenter can open multiple instance of the program and pre-configure
		/// admin settings.  The experimenter then names each instance based upon 
		/// the instance's settings.  This setup routine helps reduce the overhead
		/// of conducting experiments.
		/// </summary>
		private void setFormTitleMenuItem_Click(object sender, System.EventArgs e)
		{
			FormTitleInputForm formTitleInputForm = new FormTitleInputForm();
			formTitleInputForm.ReturnString = this.Text;
			if (formTitleInputForm.ShowDialog() == DialogResult.OK)
			{
				this.Text = formTitleInputForm.ReturnString;
			}
			formTitleInputForm.Dispose();
		}

		/// <summary>
		/// Sets a recognition rate of 85% and forces omission errors
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void er85NeglectMenuItem_Click(object sender, System.EventArgs e)
		{
			// Update UI
			er85NeglectMenuItem.Checked = true;
			errorOffMenuItem.Checked = false;
			er85MislabelMenuItem.Checked = false;

			// Set error type
			if (this.recognizer is WizardRecognizer)
			{
				WizardRecognizer recognizer = (WizardRecognizer) this.recognizer;
				recognizer.CurrentSimulatedError = WizardError.E85OMIT;
			}
		}

		/// <summary>
		/// Turns error off (e.g. for Wizard-triggered grouping errors, or for 
		/// perfect recognition).
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void errorOffMenuItem_Click(object sender, System.EventArgs e)
		{
			// Update UI
			er85NeglectMenuItem.Checked = false;
			errorOffMenuItem.Checked = true;
			er85MislabelMenuItem.Checked = false;
			...
			{
				WizardRecognizer recognizer = (WizardRecognizer) this.recognizer;
				recognizer.CurrentSimulatedError = WizardError.OFF;
			}
		}

		/// <summary>
		/// Sets a recognition rate of 85% and forces false positive errors (mislabeling)
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void er85MislabelMenuItem_Click(object sender, System.EventArgs e)
		{
			// Update UI
			er85NeglectMenuItem.Checked = false;
			errorOffMenuItem.Checked = false;
			er85MislabelMenuItem.Checked = true;

			// Set error type
			if (this.recognizer is WizardRecognizer)
			{
				WizardRecognizer recognizer = (WizardRecognizer) this.recognizer;
				recognizer.CurrentSimulatedError = WizardError.E85FALSEPOSITIVE;
			}
		}

		/// <summary>
		/// Toggles visibility of the SocketClient
		/// FIXME: for some reason, it is impossible to show/hide the SocketClient once
		/// data is sent using it.
		/// </summary>
		private void toggleSocketClientMenuItem_Click(object sender, System.EventArgs e)
		{
			if (this.recognizer is WizardRecognizer)
			{
				WizardRecognizer wizRecog = (WizardRecognizer) this.recognizer;
				wizRecog.showSocketClientGui(!toggleSocketClientMenuItem.Checked);
			}

			toggleSocketClientMenuItem.Checked = !toggleSocketClientMenuItem.Checked;
		}

		/// <summary>
		/// UI hook for reconnecting the SocketClient in case the connection gets
		/// destroyed.
		/// </summary>
		private void reconnectSocketClientMenuItem_Click(object sender, System.EventArgs e)
		{
			if (this.recognizer is WizardRecognizer)
			{
				WizardRecognizer wizRecog = (WizardRecognizer) this.recognizer;
				wizRecog.reconnectSocketClient();
			}
		...
		private void sketchPicture_Stroke(object sender, Microsoft.Ink.InkCollectorStrokeEventArgs e)
		{
			...
			// Update recognizer with new strokes
			recognizer.recognize(sketch, sketch.Strokes, false);
		}
		...
		private void sketchPicture_StrokesDeleting(object sender, InkOverlayStrokesDeletingEventArgs e)
		{
			if (sketchPicture.EditingMode == InkOverlayEditingMode.Delete) 
			{
				...
				feedbackMechanism.FireFeedbackMechanism(this.sketch, this.sketchPicture, this.inkToSketchIds, FeedbackContext.OnStrokeDeleted);
			}
		}

		/// <summary>
		/// Handles stroke events sent from the notes panel InkPicture
		/// </summary>
		/// <param name="sender">Source InkCollector that raised this event</param>
		/// <param name="e">Stroke event object containing event data</param>
		...
		/// <summary>
		/// Handles ink added events sent to the sketch InkPicture
		/// </summary>
		/// <param name="sender">Source InkCollector that raised this event</param>
		/// <param name="e">Stroke event object containing event data</param>
		...
		/// <summary>
		/// Handles ink deletion events sent to the sketch InkPicture
		/// </summary>
		/// <param name="sender">Source InkCollector that raised this event</param>
		/// <param name="e">Stroke event object containing event data</param>
		...
		public void loadSketch2SketchPanel(Sketch.Sketch newSketch)
		{
			...
			// Fire feedback mechanism
			// See region Hooks for Wizard Recognizer + Text Labels
			if (this.InvokeRequired)
			{
				WizardFeedbackCallback d = new WizardFeedbackCallback(this.fireWizardFeedback);
				this.Invoke(d, null);
			}
			else
			{
				feedbackMechanism.FireFeedbackMechanism(this.sketch, 
					this.sketchPicture, this.inkToSketchIds, FeedbackContext.OnRecognitionResult);
			}
			
			
			this.Refresh();

			this.statusBar.Text = "Status: Recognition complete.";
		}
		...
		{
			this.statusBar.Text = "Status: Receiving recognition result...";
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// Lasso-tap Annotation Tool
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		#region Lasso-tap Annotation Tool
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// Pause-triggered Recognition - Form Hook and Delegates
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		#region Pause-triggered Recognition - Form Hook and Delegates

		/// <summary>
		/// Delgates for communicating with Pause timer thread.
		/// <see cref="PauseTriggerCountdownTimer"/>
		/// </summary>
		protected delegate void FirePauseCountdown();
		protected delegate void PauseCountdownFinished();

		/// <summary>
		/// Form hook for triggering recognition.  The pause timer thread calls this 
		/// method to trigger recogntion.
		/// </summary>
		...
		/// <summary>
		/// Countdown timer class.  This class encapsulates a thread
		/// that counts down and triggers recognition upon completion.
		/// </summary>
		private class PauseTriggerCountdownTimer 
		{
			/// <summary>
			/// The parentForm running this timer.
			/// </summary>
			private UserStudyUIForm parentForm;
			...
			public PauseTriggerCountdownTimer(UserStudyUIForm parent) 
			{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// Hooks for Wizard Recognizer + Text Labels
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		#region Hooks for Wizard Recognizer + Text Labels

		/*
		 * Due to threading issues, we must have this simple hack to forward
		 * calls to the feedback mechanism when the Wizard Recognizer is employed.
		 * The problem is that receiving a sketch over the network creates thread A,
		 * but the components for this Windows Form reside in thread B.  Code from 
		 * thread A cannot modify form components in thread B because Windows Components
		 * are not thread safe.  This delegate allows the sketch receive thread to 
		 * tell the main form thread to fire the feedback mechanism.
		 * 
		 * See http://msdn2.microsoft.com/en-us/library/ms171728.aspx
		 */

		/// <summary>
		/// Deletate for sending feedback triggering event from 
		/// recognizer thread to Windows Form thread.
		/// </summary>
		public delegate void WizardFeedbackCallback();

		/// <summary>
		/// Method for triggering feedback mechanism when
		/// using the Wizard Recognizer
		/// </summary>
		public void fireWizardFeedback()
		{
			feedbackMechanism.FireFeedbackMechanism(this.sketch, this.sketchPicture, 
				this.inkToSketchIds, FeedbackContext.OnRecognitionResult);
		}
