...
namespace SketchPanelLib
{
    ...
    public abstract class SketchRecognizer
    {
        ...
        ///// <summary>
        ///// Actual Recognizer to do the classification
        ///// </summary>
        //protected Recognizers.IRecognizer classify;
...
//            parentPanel.Invoke(rrDelegate, new object[] { this, recogResult });
    ...
    /// a blank result.
    /// </summary>
    public class TimeoutSketchRecognizer : SketchRecognizer
    {
        /// <summary>
    ...
    //public class GateSketchRecognizer : SketchRecognizer
    //{
    //    public GateSketchRecognizer()
    //    {
    //        classify = new Recognizers.Recognizer(Recognizers.Algorithm.GATE);
    //    }
    ...
    //        Recognizers.Results results = classify.Recognize(substrokes);
    //        result.status = results.ToString();

    //        System.Drawing.Color c = results.ToColor();        
    ...
    //public class PartialGateSketchRecognizer : SketchRecognizer
    //{
    //    public PartialGateSketchRecognizer()
    //    {
    //        classify = new Recognizers.Recognizer(Recognizers.Algorithm.PARTIAL_GATE, new object[] {
    //            "data/partial.model",
    //            new string[] { 
    //                "data/backline.amat", 
    //                "data/backarc.amat", 
