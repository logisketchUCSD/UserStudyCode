...
namespace SketchPanelLib
{
    ...
    /// <summary>
    /// Delegate for handling zoom events sent from a SketchPanel.
    /// </summary>
    /// <param name="zoomFactor">The factor by which the display was zoomed.</param>
    public delegate void ZoomEventHandler(float zoomFactor);
    ...
    public class SketchPanel : System.Windows.Forms.Panel
    {
        ...
        /// </summary>
        protected Microsoft.Ink.InkPicture inkPic;
        ...
        /// <summary>
        /// Zoom event.  This panel publishes to this event
        /// after the panel has zoomed in or out.  This event
        /// is published after the panel has zoomed but before
        /// the panel has refreshed.
        /// </summary>
        ...
        /// <summary>
        /// Stores the time at which the user last hovered the stylus
        /// over this panel in DateTime FileTime format.  
        /// </summary>
        ...
        /// </summary>
        void inkPic_CursorInRange(object sender, InkCollectorCursorInRangeEventArgs e)
        {
        ...
        private void loadSketch(object newSketch, bool rescale, bool reset)
        {
            ...
            if (rescale)
            {
                inkSketch.Recording = false;

                // Move the Ink's origin to the upper top-left corner.
                //inkPic.Ink.Strokes.Move(-1 * inkPic.Ink.GetBoundingBox().X + SketchPanelConstants.SketchPadding, 
                //    -1 * inkPic.Ink.GetBoundingBox().Y + SketchPanelConstants.SketchPadding);
