...
namespace Utilities.Neuro
{
	...
	public abstract class Neuron : ISerializable
	{
        ...
        public Neuron(SerializationInfo info, StreamingContext ctxt)
        {
            ...
            rand = (Random)info.GetValue("rand", typeof(Random));
            randRange = (DoubleRange)info.GetValue("randRange", typeof(DoubleRange));
        }
        ...
        public virtual void GetObjectData(SerializationInfo info, StreamingContext ctxt)
        {
            ...
            info.AddValue("randRange", randRange);
        }
