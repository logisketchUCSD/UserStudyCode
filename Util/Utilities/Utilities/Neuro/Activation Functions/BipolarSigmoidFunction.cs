...
namespace Utilities.Neuro
{
	...
	/// </remarks>
	public class BipolarSigmoidFunction : IActivationFunction, ISerializable
	{
        ...
        public BipolarSigmoidFunction(SerializationInfo info, StreamingContext ctxt)
        {
            //Get the values from info and assign them to the appropriate properties
            alpha = (double)info.GetValue("alpha", typeof(double));
        }
