...
namespace Utilities.Neuro.Learning
{
	using System;
	...
	/// 
	public class BackPropagationLearning : ISupervisedLearning, ISerializable
	{
		// network to teach
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext ctxt)
        {
            ...
            info.AddValue("neuronErrors", neuronErrors);
            info.AddValue("weightsUpdates", weightsUpdates);
            info.AddValue("thresholdsUpdates", thresholdsUpdates);
        }
