...
namespace Utilities.Neuro.Learning
{
	...
	/// </remarks> 
	///
	public class ElasticNetworkLearning : IUnsupervisedLearning, ISerializable
	{
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext ctxt)
        {
            ...
            info.AddValue("learningRadius", learningRadius);
            info.AddValue("squaredRadius2", squaredRadius2);
        }
