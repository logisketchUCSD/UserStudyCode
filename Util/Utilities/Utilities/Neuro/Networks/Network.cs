...
namespace Utilities.Neuro
{
	...
	/// 
	public abstract class Network : ISerializable
	{
		/// <summary>
        ...
        public Network(SerializationInfo info, StreamingContext ctxt)
        {
            ...
            layersCount = (int)info.GetValue("layersCount", typeof(int));
            layers = (Layer[])info.GetValue("layers", typeof(Layer[]));
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext ctxt)
        {
            ...
            info.AddValue("layersCount", layersCount);
